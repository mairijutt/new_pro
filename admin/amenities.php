              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="usr">Amenities Name</label>
                    <input type="text" class="form-control" v-model="fet_name" placeholder="Type Amenities Name">
                  </div>
                </div>
                <div class="col-md-4">
        ...
        <div class="row">
          <div class="col-md-12 grid-margin stretch-card">
            <div class="table-responsive">
              <h2 class="table-heading-1">Standerd Amenities</h2>
...
<script>
    new Vue({
      ...
      mounted () {
            axios.get('http://realestate.indoortv.co/real_estate_api/amenities/all').then(res => (this.fet_list = res.data.data.all_amenities))
      },
      methods: {
            save(){
              const formData = new FormData();
                formData.append('amen_file', this.icon);
                formData.append('amen_name', this.fet_name);
                const headers = { 'Content-Type': 'multipart/form-data' };
              axios.post('http://realestate.indoortv.co/real_estate_api/amenities/add', formData, { headers }).then((res) => {this.fet_list = res.data.data.all_amenities;});
